...
public class form_show_all_scholarships extends JDialog {
    //AUTHOR: Sebastian Perez Hernandez
    //DATE: 09/06/2020
    //DESCRIPTION: This class shows the data of a file C:/PRUEBA/students.txt
    public form_show_all_scholarships(java.awt.Frame parents) {
        super(parents, true);
        setLayout(new BorderLayout());
        JPanel panel_superior = new JPanel();
        JLabel label_menu = new JLabel("List of scholarships", SwingConstants.CENTER);
        label_menu.setFont(new Font("Arial", 0, 20));
        panel_superior.add(label_menu);
        //panel central
        String[] columnsNames = {"Codigo", "Sede", "Facultad","Valor"};
        file_data_scholarships file_data_scholarships1 = new file_data_scholarships();
        JTable tabla_datos = new JTable(file_data_scholarships1.f_all_data_scholarships(), columnsNames);
